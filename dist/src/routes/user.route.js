...
userRoutes.get("/checkout", user_controller_1.UserController.showPageCheckOut);
userRoutes.post("/checkout", user_controller_1.UserController.checkOut);
userRoutes.get("/order", user_controller_1.UserController.showPageOrder);
userRoutes.get("/order-cancel/:id", user_controller_1.UserController.cancelOrder);
userRoutes.get('/product-category/:id', user_controller_1.UserController.showListByCategory);
